...
- Onboard fields live under `infra/requests/*.template.md` / skills as ordinary
  chat text — **not** exposed via MCP `/prompts`. Important set: onboard, mirror,
  explore, impact, safe-edit, verify (see `infra/requests/README.md`).